    ...
    return (
       ...
       <div className="bg-gray-900 pt-[50px] pb-[20px]">
                ...
                <div>
                    ...
                    <div className="mt-5">
                    <h2 className="text-[16px] text-white font-semibold	">"Let's Shop Beyond Boundaries"</h2>
                    </div>
                    <div className="flex h-100px mt-[60px] justify-start">
                        {/* <!-- Facebook --> */}
                        <svg
                        ...
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5 mx-1 text-slate-400"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                        >
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li><a href="#" className="text-white text-[16px] leading-loose">Mitra Blog</a></li>
                        <li><a href="#" className="text-white text-[16px] leading-loose">B2B Digital</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        ...
                        <li><a href="#" className="text-white text-[16px] leading-loose">Mitra Blog</a></li>
                        <li><a href="#" className="text-white text-[16px] leading-loose">Promo</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        ...
                        <li><a href="#" className="text-white text-[16px] leading-loose">Register Office Store</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        ...
                        <li><a href="#" className="text-white text-[16px] leading-loose">Privacy</a></li>
                        <li><a href="#" className="text-white text-[16px] leading-loose">Mitra</a></li>
                    </ul>
                </div>
            </div>
        <hr className="mt-[50px]" />
        <div className="w-full max-w-[1440px] mx-auto">
            <p className="text-gray-500 text-center mt-[15px]">@2001 - 2003, BeliBeli.com</p>
        </div>
       </div>
